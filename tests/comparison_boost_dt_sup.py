...
comparisons_directory = 'comparisons/boost_dt_sup_comparisons/'
data_directory = 'comparisons/boost_dt_sup_data/'
...
for t in range(TRIALS):
    ...
    if t == 0:
        plotter.plot_state_actions(mdp.pi, rewards=rewards, sinks=sinks,
                filename=comparisons_directory + 'boost_dt_sup_classic_il_state_action.png')        
...
np.save(data_directory + 'boost_dt_sup_sup_data.npy', value_iter_data)
np.save(data_directory + 'boost_dt_sup_classic_il_data.npy', classic_il_data)
np.save(data_directory + 'boost_dt_sup_dagger_data.npy', dagger_data)

np.save(data_directory + 'boost_dt_sup_dagger_acc.npy', dagger_acc)
np.save(data_directory + 'boost_dt_sup_classic_il_acc.npy', classic_il_acc)
...
analysis.plot(names = ['Value iteration', 'AdaBoost IL', 'DT DAgger'], filename=comparisons_directory + 'boost_dt_sup_reward_comparison.png', ylims=[-60, 100])
...
acc_analysis.plot(names = ['AdaBoost IL Acc.', 'DT DAgger Acc.'], label='Accuracy', filename=comparisons_directory + 'boost_dt_sup_acc_comparison.png', ylims=[0,1])
