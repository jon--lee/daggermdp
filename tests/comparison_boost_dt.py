...
plotter.plot_state_actions(value_iter_pi, rewards = grid.reward_states, sinks = grid.sink_states,
        filename='comparisons/boost_dt_comparisons/value_iter_state_action.png')
...
np.save('comparisons/boost_dt_data/boost_dt_sup_data.npy', value_iter_data)
np.save('comparisons/boost_dt_data/boost_dt_classic_il_data.npy', classic_il_data)
np.save('comparisons/boost_dt_data/boost_dt_dagger_data.npy', dagger_data)

np.save('comparisons/boost_dt_data/boost_dt_dagger_acc.npy', dagger_acc)
np.save('comparisons/boost_dt_data/boost_dt_classic_il_acc.npy', classic_il_acc)
...
analysis.plot(names = ['Value iteration', 'AdaBoost IL', 'DT DAgger'], filename='comparisons/boost_dt_comparisons/boost_dt_reward_comparison.png', ylims=[-60, 100])
...
acc_analysis.plot(names = ['AdaBoost IL Acc.', 'DT DAgger Acc.'], label='Accuracy', filename='comparisons/boost_dt_comparisons/boost_dt_acc_comparison.png', ylims=[0,1])
