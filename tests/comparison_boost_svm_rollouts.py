...
comparisons_directory = 'comparisons/boost_svm_rollouts_comparisons/'
data_directory = 'comparisons/boost_svm_rollouts_data/'
...
for t in range(TRIALS):
    ...
    if t == 0:
        plotter.plot_state_actions(mdp.pi, rewards=rewards, sinks=sinks,
                filename=comparisons_directory + 'boost_svm_rollouts_classic_il_state_action.png')        
...
np.save(data_directory + 'boost_svm_rollouts_sup_data.npy', value_iter_data)
np.save(data_directory + 'boost_svm_rollouts_classic_il_data.npy', classic_il_data)
np.save(data_directory + 'boost_svm_rollouts_dagger_data.npy', dagger_data)

np.save(data_directory + 'boost_svm_rollouts_dagger_acc.npy', dagger_acc)
np.save(data_directory + 'boost_svm_rollouts_classic_il_acc.npy', classic_il_acc)
...
analysis.plot(names = ['Value iteration', 'AdaBoost IL', 'RBF SVM DAgger'], filename=comparisons_directory + 'boost_svm_rollouts_reward_comparison.png', ylims=[-60, 100])
print "Saving analysis to: " + comparisons_directory + 'boost_svm_rollouts_reward_comparison.png'
...
acc_analysis.plot(names = ['AdaBoost IL Acc.', 'RBF SVM DAgger Acc.'], label='Accuracy', filename=comparisons_directory + 'boost_svm_rollouts_acc_comparison.png', ylims=[0,1])
