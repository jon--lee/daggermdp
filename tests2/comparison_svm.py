...
comparisons_directory = 'comparisons2/svm_comparisons/'
data_directory = 'comparisons2/svm_data/'
...
for t in range(TRIALS):
    ...
    mdp.load_policy()
    dagger = SVMDagger(grid, mdp, depth=5)
...
acc_analysis.plot(names = ['DT IL Acc.', 'DT DAgger Acc.'], label='Accuracy', filename=comparisons_directory + 'svm_acc_comparison.png', ylims=[0,1])
