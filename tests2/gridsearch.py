...
def make_name(ne, lr):
    short = 'comparisons2/gs_4dim_dt_'
    short += str(ne) + 'ne' + str(lr) + 'lr'
...
n_estimators_set = [1, 2, 5, 10, 20, 50, 100]
learning_rate_set = [.2, .4, .6, .8, 1.0]

#n_estimators_set = [1, 2]
#learning_rate_set = [.2]


params = list(itertools.product(n_estimators_set, learning_rate_set))
print len(params)
